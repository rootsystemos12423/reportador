...
@section('content')
    <div class="container mx-auto py-8">
        <div class="bg-zinc-800 text-white p-8 rounded-lg shadow-xl border border-gray-700">
            ...
            {{-- Formulário Estático --}}
            <form action="{{ route('store.rabbit.rules') }}" method="POST" class="space-y-6 bg-zinc-800 p-6 rounded-lg shadow-xl border border-gray-700 text-white">
                  @csrf
                  ...
                  <div>
                      ...
                      <select name="action" class="w-full p-3 rounded-md bg-zinc-700 border border-gray-600 text-white">
                  ...
                  <div>
                      ...
                      <select name="condition_operator" class="w-full p-3 rounded-md bg-zinc-700 border border-gray-600 text-white">
